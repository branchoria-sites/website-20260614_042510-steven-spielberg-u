...
show_ads: true
description: In Close Encounters of the Third Kind, Steven Spielberg turns alien communication into a problem of navigation.
hero_summary: In Close Encounters of the Third Kind, Steven Spielberg turns alien communication into a problem of navigation. The breakthrough does not come from a dramatic revelation about extraterrestrial intentions but from a sequence of numbers that scientists learn to read as geographic coordinates.
layout: default
permalink: /wyoming-coordinates-ca-19-d9/
sidebar_expanded_urls:
- /steven-spielberg-and-ufos/
- /devils-tower/
nav_short_title: Wyoming Coordinates Ca 19 D9
title: Wyoming Coordinates Ca 19 D9
title_full: Wyoming Coordinates Ca 19 D9
display_title_short: Wyoming Coordinates Ca 19 D9
display_title: Wyoming Coordinates Ca 19 D9
source_count: 21
infographic_count: 3
...
prev_link:
  ...
  permalink: /tower-nerve-gas-evac-aa-087-e/
  short_title: Tower Nerve Gas Evac Aa 087 E
date: '2026-06-14 02:20:36 '
header:
  og_image: /assets/images/steven_spielberg_and_53b32f_devils_tower_contact_d94aa1_wyoming_coordinates_ca19d9-Illustration-1-social.jpg
  preview_image: /assets/images/steven_spielberg_and_53b32f_devils_tower_contact_d94aa1_wyoming_coordinates_ca19d9-Illustration-1.webp
image: /assets/images/steven_spielberg_and_53b32f_devils_tower_contact_d94aa1_wyoming_coordinates_ca19d9-Illustration-1-social.jpg
---
...
The film therefore treats coordinates as evidence. Once the numbers can be plotted on a map, speculation gives way to action. Scientists begin organising around a location rather than a theory. The message becomes less mystical and more operational: go here.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/w_SzGX0_5WY" title="Simple Math in Close Encounters of the Third Kind" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=w_SzGX0_5WY" target="_blank" rel="noopener noreferrer">Simple Math in Close Encounters of the Third Kind</a></p><p class="youtube-embed-meta">Channel: Abakcus &middot; Views: 6.4K &middot; Uploaded: July 2020</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=w_SzGX0_5WY" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=w_SzGX0_5WY">Open on YouTube</a></p></div></div></div>

## Scientists, Witnesses and Soldiers Converge

The coordinate system creates a remarkable convergence of otherwise unrelated groups.
...
* Scientists follow decoded numbers.
* Witnesses follow psychological compulsion and visual memory.
* Government officials follow strategic necessity.

</div>

The film’s structure repeatedly demonstrates that all three routes lead to the same point in Wyoming.


<img src="{{ "/assets/images/steven_spielberg_and_53b32f_devils_tower_contact_d94aa1_wyoming_coordinates_ca19d9-Illustration-2-dark.svg" | relative_url }}" alt="Wyoming Coordinates Ca 19 D9 illustration 2" data-theme-src-dark="{{ "/assets/images/steven_spielberg_and_53b32f_devils_tower_contact_d94aa1_wyoming_coordinates_ca19d9-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/steven_spielberg_and_53b32f_devils_tower_contact_d94aa1_wyoming_coordinates_ca19d9-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## Why Mapped Contact Feels Credible

The coordinate device gives *Close Encounters* an unusual sense of realism. Viewers may not believe in UFOs, but they understand maps. Longitude and latitude belong to the everyday world of navigation, surveying and geography. By grounding the mystery in a recognisable system, Spielberg makes the extraordinary seem more plausible.

This choice also reflects the film’s broader fascination with expertise. The researchers do not solve the mystery through intuition alone. They use translation, mathematics and cartographic reasoning. The coordinate sequence functions almost like a scientific puzzle whose solution can be independently verified. Once a location is identified, anyone with a map could theoretically follow the same path.
...
## A Route Rather Than a Revelation
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Wyoming coordinates as Spielberg&#x27;s route to contact. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">The strongest fit for the page&#x27;s focus on alien communication as navigation.</p>
    ...
    <article class="fr-book-card">
      <a class="fr-book-cover" href="https://www.amazon.com/s?k=Longitude&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" aria-label="Open Longitude on Amazon"><span class="fr-book-cover-fallback">Book</span><img class="fr-book-cover-thumb" src="https://covers.openlibrary.org/b/id/99507-M.jpg" alt="Cover for Longitude" loading="lazy" decoding="async" fetchpriority="low" referrerpolicy="no-referrer" onerror="this.hidden=true;this.closest('.fr-book-cover').classList.add('fr-book-cover-placeholder');"></a>
      <div class="fr-book-info">
        <h4 class="fr-book-title">
          <a href="https://www.amazon.com/s?k=Longitude&amp;i=stripbooks&amp;tag=searcht-20" target="_blank" rel="sponsored noopener noreferrer" title="Longitude">Longitude</a>
        </h4>
        <p class="fr-book-author">By Unknown author</p>

        <p class="fr-book-desc">A commercially strong adjacent pick for the page&#x27;s longitude and location-decoding angle.</p>
        <div class="fr-book-actions">
          <a href="https://www.amazon.com/s?k=Longitude&amp;i=stripbooks&amp;tag=searcht-20" class="fr-amazon-btn" target="_blank" rel="sponsored noopener noreferrer">
            See on Amazon
          </a>
        </div>
      </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Supports the Wyoming landmark and real-place side of the contact route.</p>
        <div class="fr-book-actions">
